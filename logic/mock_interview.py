"""
AI Mock Interview — Question generation and answer evaluation
...
def mock_interview(role, difficulty, generate_fn):
    """
...
def evaluate_answer(question, answer, role, generate_fn):
    """
